#include <stdlib.h>
#include <stdio.h>
#include <string.h> //uzycie strmp
#include <errno.h>
#include <unistd.h>
#include <sys/msg.h>
#include <signal.h> //uzycie sigint
#define MAX_TEXT 512
...
int main() {
    ...
    printf("serwer gotowy, czekam na zgloszenia klientow...\n");
    while (running) {
        ...
        printf("proces o PID=%ld zada tlumaczenia slowa: %s",
        ...
        if (strcmp("rower\n", request_msg.word) == 0) {
            ...
            strcpy(response_msg.word, "nie znam takiego slowa");
        }
...
void exit_program(int sig) {
    printf("usuwam kolejki komunikatow...");
